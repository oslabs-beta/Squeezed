...
/**
 * Loop through the queue, invoking the functions in order with the input number, where the results of each invocation become the next function’s input. Additionally, the queue should be empty after the function is called.
 * let puzzlers = [
